...
# En este caso modificamos el tipo llamando al metodo nuevo_tipo ya que al ser tipo una
# propiedad encapsulada no podemos modificar directamente su valor desde el códgio principal
miVector1.nuevo_tipo(tipo2)
miVector1.x = x2
miVector1.y = y2
