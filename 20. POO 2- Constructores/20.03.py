...
# Solicitamos por teclado los datos segundo alumno
nombre = input("Nombre del segundo alumno:")
nota = float(input("Nota del segundo alumno:"))
...
# Comparamos las notas de los dos alumnos y mostramos los datos ordenados
if alumno1.nota > alumno2.nota:
    print(alumno1.nombre, "ha obtenido una nota más alta que", alumno2.nombre)
elif alumno1. nota < alumno2.nota:
    print(alumno2.nombre, "ha obtenido una nota más alta que", alumno1.nombre)
else:
    print(alumno1.nombre, "y", alumno2.nombre, "han obtenido la misma nota")
