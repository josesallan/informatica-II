...
# Creamos un segundoobjeto de la clase Triangulo
...
print("Superficie triángulo:", miTriangulo.superficie())
print()
...
print("Superficie triángulo:", miTriangulo2.superficie())

# Comparamos las superficies de los dos triángulos y mostramos la relación de tamaños por pantalla.
if miTriangulo.superficie() > miTriangulo2.superficie():
    print(" - El primer triángulo tiene una superficie mayor que el segundo.")
elif miTriangulo.superficie() < miTriangulo2.superficie():
    print(" - El segundo triángulo tiene una superficie mayor que el primero.")
else:
    print(" - Los dos triángulos tienen la misma superficie.")
